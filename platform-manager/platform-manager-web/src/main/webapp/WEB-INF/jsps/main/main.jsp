		...
		<div class="row">
			<div class="col-md-2">
				<ul id="main-nav" class="nav nav-tabs nav-stacked" style="">
					<li class="active"><a href="/main/main/main-right" target="frame"> <i
							class="glyphicon glyphicon-th-large"></i> 后台管理系统
					</a></li>
					...
					<li><a href="#scrapManager" class="nav-header collapsed"
						data-toggle="collapse"> <i class="glyphicon glyphicon-cog"></i>
							废品管理 <span class="pull-right glyphicon glyphicon-chevron-down"></span>
					</a>
					...
					<li><a href="#scraperManager" class="nav-header collapsed"
						data-toggle="collapse"> <i class="glyphicon glyphicon-cog"></i>
							废品回收员管理 <span class="pull-right glyphicon glyphicon-chevron-down"></span>
					</a>
					...
					<li><a href="#ownerManager" class="nav-header collapsed"
						data-toggle="collapse"> <i class="glyphicon glyphicon-cog"></i>
							业主管理 <span class="pull-right glyphicon glyphicon-chevron-down"></span>
					</a>
					...
					<li><a href="#villageManager" class="nav-header collapsed"
						data-toggle="collapse"> <i class="glyphicon glyphicon-cog"></i>
							小区管理 <span class="pull-right glyphicon glyphicon-chevron-down"></span>
					</a>
					...
					<li><a href="#sysManager" class="nav-header collapsed"
						data-toggle="collapse"> <i class="glyphicon glyphicon-cog"></i>
							系统管理 <span class="pull-right glyphicon glyphicon-chevron-down"></span>
					</a>
						<ul id="sysManager" class="nav nav-list collapse secondmenu"
							style="height: 0px;">
							<li><a href="http://www.baidu.com" target="frame"> <i
							...
							<li><a href="http://www.baidu.com" target="frame"> <i
									class="glyphicon glyphicon-user"></i>屏蔽词
							</a></li>
							<li><a href="http://www.baidu.com" target="frame"> <i
									class="glyphicon glyphicon-user"></i>系统日志
							</a></li>
						</ul></li>
				</ul>
			</div>
			...
			<!--右侧-->
			<div class="col-md-10">
				<iframe id="iframe" name="frame" src="/main/main/main-right"
