	...
	<form id="defaultForm" class="form-horizontal" style="margin: 20px"
		...
		<fieldset>
			...
			<div class="form-group">
				...
				<div class="col-sm-5">
					<input id="icon" class="form-control" name="icon" type="text" value="${menu.icon }"
						placeholder="请添加菜单图标">
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-5">
					<input id="name" class="form-control" name="name" type="text" value="${menu.name }"
						placeholder="请输入菜单名称">
					<p class="help-block">
			...
			<div class="form-group">
				...
				<div class="col-sm-5">
					...
					<input id="urlkey" class="form-control" name="urlkey"  value="${menu.urlkey }"
						placeholder="请输入权限名称">
					<p class="help-block">
			...
			<div class="form-group">
				...
				<div class="col-sm-5">
					...
					<input id="type" class="form-control" name="type" type="type" value="${menu.type }"
						placeholder="请输入菜单类型">
					<p class="help-block">
			...
			<div class="form-group">
				...
				<div class="col-sm-5">
					...
					<c:if test="${menu.status==1 }" > checked="checked"  </c:if>>
						显示
					</label> &nbsp;&nbsp;&nbsp;&nbsp; <label> <input type="radio"
						value="2" name="status" 
						<c:if test="${menu.status==2 }" > checked="checked"  </c:if>>
						隐藏
			...
			<div class="form-group">
				...
				<div class="col-sm-5">
					<input id="parentId" name="parentId" class="form-control" value="${menu.parentId }"
